    ...
    public class RegisteredPlayers
    {
        ...
        public void UpdateList()
        {
            ...
            try
            {
                ...
                {
                    var r1 = round1.AddEntry<ulong>(i, 0, _listBase + UnityListBase.Start + (uint)(i * 0x8));
                    ...
                    var r7 = round3.AddEntry<ulong>(i, 6, r6, null, Profile.Id);
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    scatterMap.Results[i][5].TryGetResult<ulong>(out var playerProfilePtr);
                    scatterMap.Results[i][6].TryGetResult<ulong>(out var profileIDPtr);
